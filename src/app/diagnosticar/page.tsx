...
import stylesDiagnosticar from "./diagnosticar.module.css";
...
export default function IdentificarPlanta() {
    ...
    return (
        <>
            <section className={`${stylesDiagnosticar.contenedor}`}>
                <section>
                    ...
                    <div className={"my-5 flex flex-col items-center gap-5"}>
                        <div className="col-span-full flex justify-center w-full">
                            <div
                                className={`${stylesDiagnosticar.subirFoto} flex justify-center rounded-lg border-4 border-dashed border-green-900 px-10 py-10    ${stylesDiagnosticar.fondo}`}>
                ...
                <section>
                    <div className={'flex flex-col justify-center items-start gap-4 my-12'}>
                        ...
                        <div className={`${stylesDiagnosticar.procesoSubirFoto} flex items-center gap-10`}>
                            <p className={`${stylesDiagnosticar.textoProceso} w-3/5`}>Para comenzar, selecciona una planta en tu jardín o
