        ...
        <>
            <main className={`${styles.contenedor}`}>
                <section>
                    <div
                        ...
                        <div className={'flex-1 flex flex-col items-center gap-5'}>
                            <h1 className={`${BalooBhaina2.className} text-[50px] text-[#88BC43] font-bold`}>Diagnóstico
                                de tu planta</h1>
                            ...
                            <div className={`flex-1 flex items-start flex-col gap-5`}>
                                <div>
                                    <Image src="/resultado/albahaca-enferma.jpg"
                                           alt="Albahaca-enferma" width="400"
                                           height="400"/>
                                </div>
                ...
                <section className={'flex flex-col gap-12 m-10'}>
                    <div>
                        <h1 className={`${BalooBhaina2.className} text-[45px] text-[#88BC43] font-bold`}>Estado de
                            salud</h1>
                        <div className={`flex items-center gap-5`}>
                            <div>
                                <Image className={`sm:w-20`} src="/estado/planta.png"
                                       alt="planta enferma" width="80" height="80"/>
                            </div>
                            <div>
                    ...
                    <div>
                        <h1 className={`${BalooBhaina2.className} text-[45px] text-[#88BC43] font-bold`}>Descripción
                            general</h1>
                        <p className="text-[24px]">Tu planta ha sido dañada por <span
                            className="font-bold">ORUGAS</span>,
                            que se alimentan profusamente de las hojas.</p>
                        <div className={'flex flex-col gap-1'}>
                            <p className="text-[24px] mt-4"><span className="font-bold">Consejo:</span></p>
                            <div className={'flex items-center gap-5'}>
                                <div>
                                    <Image className={`sm:w-20`} src="/estado/insecticida.png" alt="insecticida" width="80" height="80"/>
                                </div>
                    ...
                    <div>
                        <h1 className={`${BalooBhaina2.className} text-[45px] text-[#88BC43] font-bold`}>Datos</h1>
                    ...
                    <div>
                        <h1 className={`${BalooBhaina2.className} text-[45px] text-[#88BC43] font-bold`}>Síntomas</h1>
                        <p className="text-[24px] text-justify">Los síntomas de una infestación de orugas incluyen agujeros en las
                            hojas
                            y daños en bordes y
                    ...
                    <div>
                        <h1 className={`${BalooBhaina2.className} text-[45px] text-[#88BC43] font-bold`}>Solución</h1>
                        <p className="text-[24px] text-justify">
                        ...
                        <ol className="list-decimal pl-5 text-justify">
                            ...
                            <li className="text-[24px] mb-1">Introduce insectos beneficiosos. Libera en tu jardín
                                insectos
                                que se
                        ...
                        <ol className="list-decimal pl-5 text-justify">
                            <li className="text-[24px] mb-1">Eliminación manual. Usando guantes, retira las orugas de
                                las
                                plantas
                                y deséchalas en un cubo de agua jabonosa.
                            </li>
                            <li className="text-[24px] mb-1">Espolvorea las plantas con tierra de diatomeas. Este polvo
                                es
                    ...
                    <div>
                        <h1 className={`${BalooBhaina2.className} text-[45px] text-[#88BC43] font-bold`}>Prevención</h1>
                        <p className="text-[24px] text-justify">La prevención puede requerir menos esfuerzo que los intentos de
                            erradicar
                            las infestaciones ya consolidadas. Estas son las principales medidas de prevención que
                            aconsejamos tomar:</p>
                        <ol className="list-decimal pl-5 text-justify">
                            <li className={`${styles.listNumber} text-[24px] mb-1`}>Monitoriza las plantas. Revisa las plantas regularmente
                                para
                            ...
                            <li className="text-[24px] mb-1">Aplica tierra de diatomeas. Aplica tierra de diatomeas a
                                las
