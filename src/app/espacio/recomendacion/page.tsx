...
export default function RecomendacionPage() {
    ...
    const [plantRecomendation, setPlantRecomendation] = useState<PlantRecomendation[]>([]);
    ...
    useEffect(()=>{
        const fetchData = async () => {
            try {
                setLoading(true)
                const apiUrl = `${process.env.NEXT_PUBLIC_API_HOST}/api/v1/plant-suggestion/espacio?luz=${luz}&temporada=${temporada}&espacio=${espacio}`;
