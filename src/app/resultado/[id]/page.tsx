...
export default function ResultadoPage({params: {id}}: { params: { id: string } }) {
    ...
    const resultados = buscarDatosPorNombre(id);
    return (
                        ...
                        <div className={'table-container'}>
                            <table className={'vertical-header-table'}>
                                ...
                                <th className={'p-10 border'}>Nombre cientifico:</th>
                                    <td className={'p-10 border'}>{resultados?.nombre_cientifico}</td>
                                </tr>
                                <tr>
                                    <th className={'p-10 border'}>Nombres comunes</th>
                                    <td className={'p-10 border'}>
                                        {resultados?.nombre_comun}
                                    </td>
                                </tr>
                                <tr>
                                    <th className={'p-10 border'}>Género</th>
                                    <td className={'p-10 border'}>{resultados?.genero}</td>
                                </tr>
                                <tr>
                                    <th className={'p-10 border'}>Familia</th>
                                    <td className={'p-10 border'}>{resultados?.familia}</td>
                                </tr>
                                </tbody>
                            </table>
                        </div>
