        ...
        <footer
            ...
            <div className="flex-1">
                <ul className={`${stylesFooter.social_icon} flex items-center justify-center gap-8 w-full lg:w-auto`}>
                    <li><a href="https://www.instagram.com/germin.ar2024/" target="_blank"><FaInstagram className={`${stylesFooter.iconosRedes}`} /></a></li>
                    <li><a href="https://www.tiktok.com/@germin.ar2024" target="_blank"><PiTiktokLogo className={`${stylesFooter.iconosRedes}`} /></a></li>
                </ul>
            </div>
        </footer>
    )
