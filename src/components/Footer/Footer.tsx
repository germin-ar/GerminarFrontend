...
export default function Footer() {
    return (
        <footer
            ...
            <div
                className={`${stylesFooter.borde} relative w-full lg:w-1/3 flex flex-col items-center justify-center gap-5 mb-6 lg:mb-0 lg:border-0`}>
            ...
            <div className="w-full lg:w-2/3 flex flex-col lg:flex-row justify-around items-center gap-10">
